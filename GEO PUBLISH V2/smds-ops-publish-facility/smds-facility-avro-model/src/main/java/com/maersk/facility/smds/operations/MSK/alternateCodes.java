...
public class alternateCodes extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 7664023545650194440L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"alternateCodes\",\"namespace\":\"com.maersk.facility.smds.operations.MSK\",\"doc\":\"AlternateCodes Details\",\"fields\":[{\"name\":\"codeType\",\"type\":[\"null\",\"string\"]},{\"name\":\"code\",\"type\":[\"null\",\"string\"]}]}");
   ...
   */
  public static com.maersk.facility.smds.operations.MSK.alternateCodes.Builder newBuilder() {
    return new com.maersk.facility.smds.operations.MSK.alternateCodes.Builder();
  }
   ...
   * @return A new alternateCodes RecordBuilder
   */
  public static com.maersk.facility.smds.operations.MSK.alternateCodes.Builder newBuilder(com.maersk.facility.smds.operations.MSK.alternateCodes.Builder other) {
    return new com.maersk.facility.smds.operations.MSK.alternateCodes.Builder(other);
  }
   ...
   * @return A new alternateCodes RecordBuilder
   */
  public static com.maersk.facility.smds.operations.MSK.alternateCodes.Builder newBuilder(com.maersk.facility.smds.operations.MSK.alternateCodes other) {
    return new com.maersk.facility.smds.operations.MSK.alternateCodes.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<alternateCodes>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.maersk.facility.smds.operations.MSK.alternateCodes.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.maersk.facility.smds.operations.MSK.alternateCodes other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.codeType)) {
        this.codeType = data().deepCopy(fields()[0].schema(), other.codeType);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.maersk.facility.smds.operations.MSK.alternateCodes.Builder setCodeType(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.maersk.facility.smds.operations.MSK.alternateCodes.Builder clearCodeType() {
      codeType = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.maersk.facility.smds.operations.MSK.alternateCodes.Builder setCode(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.maersk.facility.smds.operations.MSK.alternateCodes.Builder clearCode() {
      code = null;
