...
public class parent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public java.util.List<com.maersk.facility.smds.operations.MSK.parentAlternateCodes> alternateCodes;
   ...
   */
  public parent(java.lang.CharSequence name, java.lang.CharSequence type, java.util.List<com.maersk.facility.smds.operations.MSK.parentAlternateCodes> alternateCodes) {
    this.name = name;
    this.type = type;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: alternateCodes = (java.util.List<com.maersk.facility.smds.operations.MSK.parentAlternateCodes>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public java.util.List<com.maersk.facility.smds.operations.MSK.parentAlternateCodes> getAlternateCodes() {
   ...
   * @param value the value to set.
   */
  public void setAlternateCodes(java.util.List<com.maersk.facility.smds.operations.MSK.parentAlternateCodes> value) {
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<parent>
    ...
    private java.util.List<com.maersk.facility.smds.operations.MSK.parentAlternateCodes> alternateCodes;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.maersk.facility.smds.operations.MSK.parent.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.maersk.facility.smds.operations.MSK.parent.Builder setType(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.maersk.facility.smds.operations.MSK.parent.Builder setAlternateCodes(java.util.List<com.maersk.facility.smds.operations.MSK.parentAlternateCodes> value) {
    ...
    public parent build() {
      try {
        ...
        record.alternateCodes = fieldSetFlags()[2] ? this.alternateCodes : (java.util.List<com.maersk.facility.smds.operations.MSK.parentAlternateCodes>) defaultValue(fields()[2]);
        return record;
