...
public class ProducerKafkaConfig {
    ...
    @Qualifier("empPublishFacilityConfiguration")
    @Autowired
    String empPublishFacilityConfiguration;
    ...
    public Properties retrieveEmpPublishCustomerConf() {
        ...
        try {
            smdsMdJdbcTemplate.query(empPublishFacilityConfiguration, rs->{
                properties.put(rs.getString("PROPERTY_NAME"), rs.getString("PROPERTY_VALUE"));
            });

        } catch (Exception e) {
            throw new DataRetrievalException("Error getting EMP Publish Facility configurations :: " + e);
        }
        return properties;
    }
