...
public GeographyMessageData getGeographyMessage(String geoRowID, String eventDetails) throws Exception {
    ...
    return GeographyMessageData.builder().geographyEntity(GeographyEntityData.builder()
            .geographyData(geography.builder()
                    ...
                    .bdaLocationsDetails(bdaLocDetailsList).build()).build()).build();
