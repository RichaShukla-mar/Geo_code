 ...
 *         &lt;element name="pendingBVT" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/>
 *         &lt;element name="dataUpdateType" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
public class TaskType {
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "dataUpdateType", namespace = "urn:informatica.mdm.av.xsd", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "description", namespace = "urn:informatica.mdm.av.xsd", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "displayType", namespace = "urn:informatica.mdm.av.xsd", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "pendingBVT", namespace = "urn:informatica.mdm.av.xsd", type = JAXBElement.class, required = false),
