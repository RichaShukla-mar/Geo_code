...
/**
 * <p>Java class for FacilityOfferingGroupType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="FacilityOfferingGroupType">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element ref="{http://services.apmoller.net/cmd/schemas}FacilityOfferingGroupCode"/>
 *         &lt;element name="FacilityOfferings" type="{http://services.apmoller.net/cmd/schemas}FacilityOfferingType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "FacilityOfferingGroupType", propOrder = {
    "facilityOfferingGroupCode",
    "facilityOfferings"
})
public class FacilityOfferingGroupType {
    ...
    protected List<FacilityOfferingType> facilityOfferings;
     ...
     * {@link FacilityOfferingType }
     * 
     * 
     */
    public List<FacilityOfferingType> getFacilityOfferings() {
        if (facilityOfferings == null) {
            facilityOfferings = new ArrayList<FacilityOfferingType>();
        }
